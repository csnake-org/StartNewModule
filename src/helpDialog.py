...
class HelpDialog(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        text += "    * for type \"Gimias Plugin widget\" put only MyNewFunctionality it will add automatically PanelWidget and Processor\n"
        ...
        text += "    * for type \"Gimias Plugin\" MySrcFolder/src/Apps/Plugins or MySrcFolder/src/plugins\n"
        text += "    * for type \"Gimias Plugin widget\" MySrcFolder/src/Apps/Plugins/MyNewNamePlugin or MySrcFolder/src/plugins/MyNewNamePlugin\n"
        text += "    * for type \"ThirdParty\" MySrcFolder/thirdParty or MySrcFolder/src/thirdparties\n"
        text += "3. Select Type \"library\" or \"Gimias Plugin\" or \"Gimias Plugin widget\" or \"ThirdParty\"\n"
        text += "4. (for type \"library\", \"Gimias Plugin\" and \"ThirdParty\"  only) Set Toolkit csn file to your MySrcFolder/src/csnCISTIBToolkit.py or csnMyToolkit.py \n"
        text += "5. (for type \"Gimias Plugin\" only) Set your Gimias csn file to your MySrcFolder/src/Apps/csnGIMIAS.py or MySrcFolder/src/csnGIMIAS.py \n"
