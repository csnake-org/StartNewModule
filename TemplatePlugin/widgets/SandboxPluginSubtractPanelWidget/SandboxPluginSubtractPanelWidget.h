...
\date 24 oct 2008
*/
class SubtractPanelWidget : public SandboxPluginSubtractPanelWidgetUI
{

// OPERATIONS
public:
	//!
	SubtractPanelWidget(wxWindow* parent, int id);
	...
	void Init(	
		SubtractProcessor::Pointer processor,
...
private:
	...
	Core::Widgets::AcquireDataEntityInputControl* m_AcquireInputWidget2;
