...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.cmbNewProjectType = wx.ComboBox(self, -1, choices=["Library", "GIMIAS Plugin"], style=wx.CB_DROPDOWN)
        self.text_ctrl_1 = wx.TextCtrl(self, -1, "Users at CILab should consult the Scientific Development Team before creating a new module", style=wx.TE_MULTILINE|wx.TE_READONLY)
...
if __name__ == "__main__":
    rootForTemplateFiles = os.path.dirname(sys.argv[0])
    if not os.path.exists("%s/TemplatePlugin" % rootForTemplateFiles):
        rootForTemplateFiles = os.path.abspath("%s/../../../cilabResources/StartNewModule" % rootForTemplateFiles)
